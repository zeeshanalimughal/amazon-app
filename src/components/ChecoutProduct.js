...
dispatch(removeFromBasket({id}));
    ...
    return (
        <div className="grid grid-cols-5">
           ...
           <button onClick={addItemToBasket} className='button mt-auto text-gray-800'>Add to Cart</button>

           <button onClick={removeItemFromBasket} className='button mt-auto text-gray-800'>Remove from Cart</button>
           </div>
        </div>
    )
}
